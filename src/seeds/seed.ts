...
name:"aaaa",
password:bcryptjs.hashSync("1111111",10),
role:"admin"
    },

    {
        email:"qqqq@gmial.com",
        name:"qqqq",
        password:bcryptjs.hashSync("1111111",10),
        role:"user"
            },
...
['Shirts','Pants','Hoodies','Hats'],
    ...
    products:  [
        ...
        
        {
            ...
            images: [
                'IMG-20240602-WA0020-removebg-preview.jpg',
                'IMG-20240602-WA0024-removebg-preview.jpg'
            ],
            inStock: 10,
            price: 130,
            sizes: ['S','M','L','XL','XXL'],
...

        {
            ...
            images: [
               'IMG-20240602-WA0019-removebg-preview.jpg',
                'IMG-20240602-WA0025(2)-removebg-preview.jpg',
            ],
            inStock: 50,
            price: 45,
            sizes: ['XS','S','M','L'],
        ...
        },
        {
            ...
            images: [
                'IMG-20240602-WA0019-removebg-preview.jpg',
                'IMG-20240602-WA0018-removebg-preview.jpg',
            ],
            inStock: 50,
            price: 40,
            sizes: ['M','L','XL','XXL'],
